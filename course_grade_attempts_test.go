...
var mockCourseGradeAttemptsService =
  api.NewService ("localhost", mockToken, mockCourseGradeAttemptsRoundTripper)

var mockCourseGradeAttemptsRoundTripper = new (_MockCourseGradeAttemptsRoundTripper)
